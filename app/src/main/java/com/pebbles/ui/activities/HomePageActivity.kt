...
class HomePageActivity : BaseActivity(), DevicesAdapter.DeviceListClickListener {
    ...
    private fun intiDevicesView() {
        ...
        deviceRecyclerView.layoutManager = LinearLayoutManager(this, LinearLayoutManager.HORIZONTAL, false)

        val snapHelper = LinearSnapHelper()
        snapHelper.attachToRecyclerView(deviceRecyclerView)
        deviceRecyclerView.post(Runnable {
            adapter = DevicesAdapter(list,this, deviceRecyclerView)
